    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-success mb-3" type="button" href="/supplier/create">Tambah Supplier</a>
                    ...
                    <tbody>
                        ...
                        foreach ($result as $value) : ?>
                            <tr>
                                ...
                                <td><?= $value->phone ?></td>
                                <td>
                                    <a class="btn btn-primary" href="/supplier/edit/<?= $value->supplier_id ?>" role="button">Ubah </a>
